import { ArrowUpRight, BrainCircuit, Glasses } from "lucide-react"
    ...
    return (
      <section id="schools" className="mx-auto max-w-6xl px-4 py-16 lg:px-8 lg:py-20">
        <div className="mb-12 max-w-2xl">
          <p className="font-mono text-[11px] uppercase text-muted-foreground">Two schools · One identity</p>
          ...
          <p className="mt-4 text-base leading-7 text-muted-foreground">
            One profile on sof.ai unlocks both sister schools. Pick the pathway that matches your goal.
          </p>
        </div>
            ...
            <div key={key}
              ...
              <a href={school.url} target="_blank" rel="noopener noreferrer"
                ...
                <div className="flex items-center gap-3">
                  <span className="flex h-11 w-11 items-center justify-center rounded-md bg-stone-950 text-white">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <a href={school.url} target="_blank" rel="noopener noreferrer"
                    className="shrink-0 text-muted-foreground hover:text-foreground transition" aria-label={`Open ${school.name}`}>
