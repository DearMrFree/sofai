import type { Metadata, Viewport } from "next"
  ...
  export const metadata: Metadata = {
    ...
    publisher: SITE.name,
    keywords: [
      "School of Freedom", "Movement Thinking", "Dr. Freedom Cheteni",
      "The VR School", "The AI School", "School of AI",
      "corporate education partnerships", "school district partnerships",
      "self-driving classroom", "manifesto", "moonshot education",
    ],
    openGraph: {
